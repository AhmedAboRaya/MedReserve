const SignUpSkeletonLoader = () => {
  return (
    <div className="flex items-center justify-center h-screen bg-light-bg px-10 sm:px-0">
      <div className="flex flex-col md:flex-row space-x-2 w-full max-w-5xl"> 
        ...
        <div className="flex-1 bg-gray-300 rounded-md animate-pulse p-10 pt-40 flex flex-col items-center justify-center"> 
          <div className="h-8 bg-gray-400 rounded-md mb-4 animate-pulse w-full"></div> 
          <div className="h-10 bg-gray-400 rounded-md mb-4 animate-pulse w-full"></div>
          <div className="h-10 bg-gray-400 rounded-md mb-4 animate-pulse w-full"></div> 
          <div className="h-10 bg-gray-400 rounded-md mb-4 animate-pulse w-full"></div> 
          <div className="h-10 bg-gray-400 rounded-md mb-4 animate-pulse w-full"></div> 
          <div className="h-10 bg-gray-400 rounded-md mb-4 animate-pulse w-full"></div> 
